...
@Entity
public class GetInsuranceDetails {
	...
	public String toString() {
		return "GetInsuranceDetails [insuRegistrationId=" + insuRegistrationId + ", companyId=" + companyId
				+ ", companyName=" + companyName + ", familyId=" + familyId + ", proposerMiddleName="
				+ proposerMiddleName + ", noOfAdult=" + noOfAdult + ", noOfChildren=" + noOfChildren
				+ ", eldestMemberAge=" + eldestMemberAge + ", cover=" + cover + ", premium=" + premium
				+ ", proposerContactNo=" + proposerContactNo + ", proposerEmailId=" + proposerEmailId
				+ ", proposerFirstName=" + proposerFirstName + ", proposerLastName=" + proposerLastName
				+ ", proposerDob=" + proposerDob + ", proposerPanNo=" + proposerPanNo + ", proposerAdharNo="
				+ proposerAdharNo + ", proposerAnualIncome=" + proposerAnualIncome + ", proposerTempAddress="
				+ proposerTempAddress + ", proposerCountryId=" + proposerCountryId + ", countryName=" + countryName
				+ ", proposerStateId=" + proposerStateId + ", stateName=" + stateName + ", proposerCityId="
				+ proposerCityId + ", cityName=" + cityName + ", proposerPincode=" + proposerPincode
				+ ", proposerPermanentAddress=" + proposerPermanentAddress + ", proposerPermanentStateId="
				+ proposerPermanentStateId + ", proposerPermanentCityId=" + proposerPermanentCityId
				+ ", proposerPermanentPinCode=" + proposerPermanentPinCode + ", delStatus=" + delStatus + ", int1="
				+ int1 + ", int2=" + int2 + ", string1=" + string1 + ", string2=" + string2 + ", noOfYears=" + noOfYears
				+ ", appStatus=" + appStatus + ", regDate=" + regDate + ", dueDate=" + dueDate + "]";
	}
