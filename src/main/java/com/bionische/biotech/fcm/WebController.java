package com.bionische.biotech.fcm;
...
public class WebController {
	...
	private final String TOPIC = "main";
	
	@Autowired
	Environment env;
	
	
	@RequestMapping(value = "/notifyUser", method = RequestMethod.GET, produces = "application/json")
	public ResponseEntity<String> notifyUser() throws JSONException {
		...
		try {
			   ...
			   data.put("message","Welcome to Bionische Healthcare");
			   data.put("image",image);
			   data.put("timestamp","2019-01-07 5:59:20");
	...
	public ResponseEntity<String> notifyiOSUser() throws JSONException {
