...
public class GetPharmacyPrescriptionReceipt {
	...
	public String toString() {
		return "GetPharmacyPrescriptionReceipt [receiptNo=" + receiptNo + ", medicalId=" + medicalId + ", medicalName="
				+ medicalName + ", createdDate=" + createdDate + ", totAmount=" + totAmount + ", txnId=" + txnId
