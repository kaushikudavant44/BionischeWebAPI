...
public interface GetPharmacyPrescriptionPaymentForReceiptRepository extends JpaRepository<GetPharmacyPrescriptionPaymentForReceipt, Integer>{
	...
	@Query(value="select t.medical_request_id as appoint_id, t.medical_id, t.amount, t.txn_id, t.payment_date, t.patient_id from  prescription_to_medical"
	...
	List<GetPharmacyPrescriptionPaymentForReceipt> getPharmacyPrescriptionPaymentForReceipt(int medicalId,
