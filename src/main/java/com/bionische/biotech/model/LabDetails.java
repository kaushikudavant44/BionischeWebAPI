...
public class LabDetails {
	...
	public String toString() {
		return "LabDetails [labId=" + labId + ", cityId=" + cityId + ", stateId=" + stateId + ", countryId=" + countryId
				+ ", userName=" + userName + ", password=" + password + ", labName=" + labName + ", address=" + address
				+ ", fromTime=" + fromTime + ", toTime=" + toTime + ", owner=" + owner + ", licenceNo=" + licenceNo
