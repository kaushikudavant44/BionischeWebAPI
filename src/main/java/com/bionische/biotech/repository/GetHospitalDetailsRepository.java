...
public interface GetHospitalDetailsRepository extends JpaRepository<GetHospitalDetails, Integer>{
	...
	@Query(value="SELECT d.id, d.doctor_id, d.hospital_id, h.hospital_name, h.cityid, c.city_name, h.state_id, s.state_name, h.email_id, h.address, h.contact_no\r\n" + 
	...
	@Query(value="SELECT d.id, d.doctor_id, h.hospital_name, h.contact_no, h.email_id, \r\n" + 
