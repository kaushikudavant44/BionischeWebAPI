...
public interface GetDoctorProfileRepository extends JpaRepository<GetDoctorProfile, Integer>{
	...
	@Query(value=" SELECT d.doctor_id, d.f_name, d.l_name, d.m_name,d.gender, d.city_id,"
			...
			+ " d.passing_year, d.spec_id, s.spec_type, d.council_reg_no, d.council_name,d.fees , d.int_2, d.del_status"
			+ " from doctor_details d, doctor_specialization s, city c where doctor_id=:doctorId AND d.city_id=c.city_id AND d.spec_id=s.spec_id AND d.del_status=0",nativeQuery=true)
