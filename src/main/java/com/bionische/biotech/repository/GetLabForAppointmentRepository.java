...
public interface GetLabForAppointmentRepository extends JpaRepository<GetLabForAppointment, Integer>{
	...
	+" l.contact, l.email, l.lat, l.longitude from lab_details l, city c where l.city_id=c.city_id AND l.city_id=:cityId AND l.tests_types"
			+" LIKE :testId AND l.del_status=0 ORDER BY rating DESC ",nativeQuery=true)
