...
public interface PateintReportPaymentDetailsRepository extends JpaRepository<PateintReportPaymentDetails, Integer>{
	...
	@Query(value="SELECT r.report_id,t.id as txn_table_id, r.report_date,l.lab_name,r.report_file_name,r.int_2 AS payment_status,lt.lab_test_name,r.lab_test_id,t.created_date,t.amount_type,t.amount,t.discount,\r\n" + 
