...
public interface PharmacySubscriptionDetailsRepository extends JpaRepository<PharmacySubscriptionDetails, Integer>{
	...
	PharmacySubscriptionDetails findTop1ByPackageExpDateGreaterThanEqualAndMedicalIdAndTxnStatusOrderBySuscriptionIdDesc(String date, int medicalId,int txnStatus);
